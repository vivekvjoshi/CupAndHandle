...
def check_fundamentals(ticker, min_market_cap_billions=5):
    ...
    try:
        ...
        # Note: calling .calendar might result in extra API call
        # Optimization: We already have 'stock' object
        # safe_earnings, msg = check_earnings_volatility(stock)
        # if not safe_earnings:
        #    return False, msg
